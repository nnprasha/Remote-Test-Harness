/////////////////////////////////////////////////////////////////////
// Client2.cs - Client of the test harness                          //
...
namespace RemoteTestHarness
{
    class Client2
    {
        ...
        public string endPoint { get; } = Comm<Client2>.makeEndPoint("http://localhost", 8080, "Client2");
        ...
        public void QueryTheRepoForAllLogs()
        {
            ...
            string remoteEndPoint = Comm<Client2>.makeEndPoint("http://localhost", 8080, "RepositoryServer");
